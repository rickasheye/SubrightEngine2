...
namespace Raylib_cs
{
    ...
    {
        private readonly int buffersCount; // Number of vertex buffers (multi-buffering support)
        private readonly int currentBuffer; // Current buffer tracking in case of multi-buffering
        private readonly IntPtr vertexBuffer; // Dynamic buffer(s) for vertex data

        private readonly IntPtr draws; // Draw calls array, depends on textureId
        private readonly int drawsCounter; // Draw calls counter
        private readonly float currentDepth; // Current depth value for next draw
    }
    ...
    public static class Rlgl
    {
        ...
        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void rlFrustum(double left, double right, double bottom, double top, double znear,
            double zfar);

        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void rlOrtho(double left, double right, double bottom, double top, double znear,
            double zfar);
        ...
        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void rlSetVertexAttribute(uint index, int compSize, int type, bool normalized, int stride,
            IntPtr pointer);
        ...
        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void rlDrawVertexArrayElementsInstanced(int offset, int count, IntPtr buffer,
            int instances);
        ...
        /// </summary>
        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern uint rlLoadTexture(IntPtr data, int width, int height, PixelFormat format,
            int mipmapCount);
        ...
        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void rlGetGlTextureFormats(PixelFormat format, ref uint glInternalFormat,
            ref uint glFormat, ref uint glType);
        ...
        public static extern void rlFramebufferAttach(uint fboId, uint texId, FramebufferAttachType attachType,
            FramebufferAttachTextureType texType, int mipLevel);
