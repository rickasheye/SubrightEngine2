...
namespace SubrightEngine2.UI
{
    public class Toolbar : GameObject
    {
        ...
        {
            base.Draw2D(ref cam);
            DrawRectangle(Vector2.zero, new Vector2(Raylib.GetScreenWidth(), 12), SCPBreakdown.EngineStuff.Color.GRAY);
            DrawText("Toolbar", new Vector2(2, 2), 8, SCPBreakdown.EngineStuff.Color.WHITE);
        }
    }
}